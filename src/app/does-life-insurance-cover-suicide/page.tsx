...
export const metadata: Metadata = {
  ...
  description:
    "A fast, factual, respectful explanation of how life insurance policies handle death by suicide, including the standard exclusion period.",
  openGraph: { title: "Does Life Insurance Cover Suicide?", description: "A fast, factual, respectful explanation of how life insurance policies handle death by suicide, including the standard exclusion period." },

  twitter: { title: "Does Life Insurance Cover Suicide?", description: "A fast, factual, respectful explanation of how life insurance policies handle death by suicide, including the standard exclusion period." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          This is a sensitive question, and a common one. Here&apos;s a fast, factual answer —
          along with a resource if you or someone you know needs support right now.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          policy includes a suicide exclusion period, commonly the first two years the policy is
          in force. A death by suicide that occurs after that period has passed is generally
          treated like any other covered cause of death, with the full death benefit paid to the
          beneficiary.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          for that honor-system approach. It applies the same way to every applicant, at every
          carrier, automatically, as a standard printed policy term rather than a decision made
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          type — comparing carriers won&apos;t make this term disappear. Once it passes, a
          suicide exclusion has no more bearing on a claim than any other early-period policy
          term that has already run its course.
        </p>
