...
export const metadata: Metadata = {
  ...
  description:
    "Group life insurance through work is often free, but it's usually small and tied to your job. A fast comparison against a policy you own yourself.",
  openGraph: { title: "Employer Life Insurance vs. an Individual Policy", description: "Group life insurance through work is often free, but it's usually small and tied to your job. A fast comparison against a policy you own yourself." },

  twitter: { title: "Employer Life Insurance vs. an Individual Policy", description: "Group life insurance through work is often free, but it's usually small and tied to your job. A fast comparison against a policy you own yourself." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          they&apos;d compare and buy on their own. Both have a place — but understanding what
          group coverage actually promises, and when it stops, changes how you should think about
          it.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          a limited window after your coverage ends to compare and make that choice.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          retirement — the coverage worth comparing and locking in on your own is the kind that
          stays with your family no matter what.
        </p>
