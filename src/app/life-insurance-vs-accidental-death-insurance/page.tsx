...
export const metadata: Metadata = {
  ...
  description:
    "A fast comparison: accidental death insurance only pays for accidents, not illness or natural causes. Here's why that distinction matters, especially later in life.",
  openGraph: { title: "Life Insurance vs. Accidental Death Insurance", description: "A fast comparison: accidental death insurance only pays for accidents, not illness or natural causes. Here's why that distinction matters, especially later in life." },

  twitter: { title: "Life Insurance vs. Accidental Death Insurance", description: "A fast comparison: accidental death insurance only pays for accidents, not illness or natural causes. Here's why that distinction matters, especially later in life." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          doesn&apos;t care what the cause was. Here&apos;s the fast comparison.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          comparing it for what it is: a narrow, supplemental layer, not a substitute for a
