...
export const metadata: Metadata = {
  ...
  description:
    "A fast comparison: a savings account only holds what you've deposited. A life insurance policy can pay its full amount from day one. Here's how to think about both.",
  openGraph: { title: "Life Insurance vs. a Savings Account", description: "A fast comparison: a savings account only holds what you've deposited. A life insurance policy can pay its full amount from day one. Here's how to think about both." },

  twitter: { title: "Life Insurance vs. a Savings Account", description: "A fast comparison: a savings account only holds what you've deposited. A life insurance policy can pay its full amount from day one. Here's how to think about both." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          fundamentally different ways. Comparing the difference is less about which is
