...
export const metadata: Metadata = {
  ...
  description:
    "Fast, honest ways to reduce funeral costs — from knowing your rights under the FTC Funeral Rule to comparing direct burial — and why coverage still matters even with a simple plan.",
  openGraph: { title: "How to Reduce Funeral Costs", description: "Fast, honest ways to reduce funeral costs — from knowing your rights under the FTC Funeral Rule to comparing direct burial — and why coverage still matters even with a simple plan." },

  twitter: { title: "How to Reduce Funeral Costs", description: "Fast, honest ways to reduce funeral costs — from knowing your rights under the FTC Funeral Rule to comparing direct burial — and why coverage still matters even with a simple plan." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          people realize going in. A few fast, practical steps — most of them about comparing
          options rather than cutting corners — can make a meaningful difference.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          fastest ways to avoid paying for more than you need.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          what a funeral home offers on-site, so it&apos;s worth comparing whether this option
          makes sense before defaulting to whatever the funeral home has on the floor.
        </p>
