...
export const metadata: Metadata = {
  ...
  description:
    "How final expense (burial) insurance works, the two main policy types, what affects your premium, and how to compare options fast — in plain language.",
  openGraph: { title: "Final Expense Insurance Explained", description: "How final expense (burial) insurance works, the two main policy types, what affects your premium, and how to compare options fast — in plain language." },

  twitter: { title: "Final Expense Insurance Explained", description: "How final expense (burial) insurance works, the two main policy types, what affects your premium, and how to compare options fast — in plain language." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          you need full coverage in place, and comparing both fast is how most people figure out
          which fits.
        </p>
        ...
        <div className="mt-14 rounded-2xl bg-canvas-alt p-7">
          ...
          <p className="mt-3 text-base leading-relaxed text-charcoal/80">
            FinalExpense.Contact exists to make comparing final expense insurance fast. We
            partner with multiple providers so we can line up dozens of plans side by side to
            find the best value for each customer, instead of pointing everyone toward a single
