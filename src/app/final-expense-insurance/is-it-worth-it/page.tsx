    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          Here&apos;s a genuinely balanced look at both sides, so you can compare and decide for
          yourself.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          have you actually compared whether the amount is enough once you account for more than
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          either side of it. If you want a second opinion, a licensed agent can help you compare
