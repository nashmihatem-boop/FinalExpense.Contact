...
export const metadata: Metadata = {
  ...
  description: "Who your information may be shared with when you submit a request on FinalExpense.Contact.",
  robots: { index: false, follow: true },
  openGraph: { title: "Our Network of Partners — FinalExpense.Contact" },
  twitter: { title: "Our Network of Partners — FinalExpense.Contact" },
};
...
export default function OurNetworkOfPartnersPage() {
  return (
    <LegalPage title="Our Network of Partners" updated="September 24, 2026">
      <p>
        FinalExpense.Contact is operated by {siteConfig.legalEntity}. When you submit a request on
