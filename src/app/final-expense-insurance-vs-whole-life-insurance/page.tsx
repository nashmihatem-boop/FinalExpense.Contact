...
export const metadata: Metadata = {
  ...
  description:
    "Final expense insurance is actually a type of whole life insurance — a smaller, simplified version built for a specific purpose. Here's how the two compare, fast.",
  openGraph: { title: "Final Expense Insurance vs. Whole Life Insurance", description: "Final expense insurance is actually a type of whole life insurance — a smaller, simplified version built for a specific purpose. Here's how the two compare, fast." },

  twitter: { title: "Final Expense Insurance vs. Whole Life Insurance", description: "Final expense insurance is actually a type of whole life insurance — a smaller, simplified version built for a specific purpose. Here's how the two compare, fast." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          insurance. The confusion is understandable, and worth clearing up fast.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          easy to compare a whole life quote in one context and a final expense quote in another
          and assume something doesn&apos;t add up when the numbers and questions look completely
