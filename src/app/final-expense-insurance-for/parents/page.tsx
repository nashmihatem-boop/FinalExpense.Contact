...
export const metadata: Metadata = {
  ...
  description:
    "How adult children typically start the conversation, what a parent needs to be involved in, and how payment and ownership commonly work — compared fast.",
  openGraph: { title: "Final Expense Insurance for a Parent", description: "How adult children typically start the conversation, what a parent needs to be involved in, and how payment and ownership commonly work — compared fast." },

  twitter: { title: "Final Expense Insurance for a Parent", description: "How adult children typically start the conversation, what a parent needs to be involved in, and how payment and ownership commonly work — compared fast." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          they have any preferences you don&apos;t know about, and whether they&apos;ve compared
          coverage before. Some parents have been putting it off out of discomfort and are quietly
          relieved someone else brought it up; others want to feel in control of the decision, not
          just informed of it after the fact. Either way, going in ready to listen tends to go
          better than going in with a plan already decided.
        </p>
