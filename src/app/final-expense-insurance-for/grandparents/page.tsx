...
export const metadata: Metadata = {
  ...
  description:
    "How grandchildren and extended family typically compare and arrange final expense coverage for a grandparent, and how to coordinate with the rest of the family.",
  openGraph: { title: "Final Expense Insurance for a Grandparent", description: "How grandchildren and extended family typically compare and arrange final expense coverage for a grandparent, and how to coordinate with the rest of the family." },

  twitter: { title: "Final Expense Insurance for a Grandparent", description: "How grandchildren and extended family typically compare and arrange final expense coverage for a grandparent, and how to coordinate with the rest of the family." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          Grandchildren and extended family compare and arrange final expense coverage more often
          than you might think — especially when a grandparent&apos;s own children aren&apos;t in
          a position to, or when a grandchild has simply grown closest to them. Here&apos;s what
          to know if that&apos;s your situation.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          ends up the natural person to notice the gap and do something about it, fast. It can
          also come up after a scare: a fall, a diagnosis, or a hospital stay that makes the lack
          of coverage suddenly feel urgent instead of hypothetical.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          reasonably be involved, it&apos;s worth a quick family conversation before you compare
          options — mainly so you don&apos;t end up with two relatives independently arranging
          overlapping coverage, or disagreement later about who the beneficiary should be. Clarify
          up front whether you&apos;re buying this to relieve the burden from your
          grandparent&apos;s own children specifically, to be reimbursed by the family after the
          fact, or simply because you want to be the one who handles it. None of those reasons
          need anyone&apos;s permission, but naming the reason out loud tends to prevent confusion
          later.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          application. You can absolutely lead on research, comparing options fast, and handling
          the logistics, but plan for your grandparent to be present, even briefly, when the
