...
export const metadata: Metadata = {
  ...
  description:
    "Why couples often compare final expense coverage for each other, who should apply, how beneficiaries typically work, and how to get started fast.",
  openGraph: { title: "Final Expense Insurance for a Spouse", description: "Why couples often compare final expense coverage for each other, who should apply, how beneficiaries typically work, and how to get started fast." },

  twitter: { title: "Final Expense Insurance for a Spouse", description: "Why couples often compare final expense coverage for each other, who should apply, how beneficiaries typically work, and how to get started fast." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          also a bill, and often one that lands during an already difficult stretch. Comparing
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          reflect anything other than two separate health histories. Comparing both sets of
          results side by side is still the fastest way to see where you each land. If one of you
          has a health condition that complicates things, our{" "}
