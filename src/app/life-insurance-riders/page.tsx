...
export const metadata: Metadata = {
  ...
  description:
    "A fast breakdown of what a rider adds to a base policy, with the two most common examples: accelerated death benefit and waiver-of-premium riders.",
  openGraph: { title: "Life Insurance Riders, Explained", description: "A fast breakdown of what a rider adds to a base policy, with the two most common examples: accelerated death benefit and waiver-of-premium riders." },

  twitter: { title: "Life Insurance Riders, Explained", description: "A fast breakdown of what a rider adds to a base policy, with the two most common examples: accelerated death benefit and waiver-of-premium riders." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          a few of the more common ones, compared fast.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          premium, is a fast question to bring to an agent before you apply, not something
