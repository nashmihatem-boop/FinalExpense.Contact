...
export const metadata: Metadata = {
  ...
  description:
    "A fast, plain-language comparison of whole life and universal life insurance — fixed guarantees versus flexible premiums — and where final expense insurance fits.",
  openGraph: { title: "Whole Life vs. Universal Life Insurance", description: "A fast, plain-language comparison of whole life and universal life insurance — fixed guarantees versus flexible premiums — and where final expense insurance fits." },

  twitter: { title: "Whole Life vs. Universal Life Insurance", description: "A fast, plain-language comparison of whole life and universal life insurance — fixed guarantees versus flexible premiums — and where final expense insurance fits." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          and the difference matters when you&apos;re comparing which one actually fits your
          situation.
        </p>
