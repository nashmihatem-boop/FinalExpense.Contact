...
export const metadata: Metadata = {
  ...
  description:
    "How material, size, and engraving affect headstone and grave marker pricing, and how to compare and get an accurate quote.",
  openGraph: { title: "What Affects Headstone & Grave Marker Cost", description: "How material, size, and engraving affect headstone and grave marker pricing, and how to compare and get an accurate quote." },

  twitter: { title: "What Affects Headstone & Grave Marker Cost", description: "How material, size, and engraving affect headstone and grave marker pricing, and how to compare and get an accurate quote." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 rounded-2xl border border-mist bg-canvas-alt p-6">
          <p className="text-sm font-bold text-harbor">Getting a real quote, fast</p>
          <p className="mt-2 text-sm leading-relaxed text-charcoal/75">
            ...
            installation fee are sometimes quoted together and sometimes billed separately.
            Compare that real number from a local provider before deciding how much coverage to
            put toward it, with some cushion left for whatever else comes up.
          </p>
        </div>
