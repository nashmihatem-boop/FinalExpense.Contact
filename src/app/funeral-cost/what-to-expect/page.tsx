...
export const metadata: Metadata = {
  ...
  description:
    "A step-by-step walkthrough of the funeral planning process and the decisions — and costs — involved at each stage, so you can compare options fast.",
  openGraph: { title: "What to Expect When Planning a Funeral", description: "A step-by-step walkthrough of the funeral planning process and the decisions — and costs — involved at each stage, so you can compare options fast." },

  twitter: { title: "What to Expect When Planning a Funeral", description: "A step-by-step walkthrough of the funeral planning process and the decisions — and costs — involved at each stage, so you can compare options fast." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          free to call around and compare before committing to one — you don&apos;t have to use
          the first, nearest, or most familiar name. Providers are required to give you pricing
          information over the phone if you ask, which makes a quick round of calls worth the
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          Prices are set locally and individually by each provider, so the fastest way to know an
          ...
          than in the middle of one, that&apos;s the ideal time to compare estimates: a current
          number from a local provider, with no pressure and no clock running.
        </p>
