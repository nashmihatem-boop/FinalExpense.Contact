    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          realize, thanks to a federal rule worth knowing before you compare prices.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          elsewhere. For a family that wants to compare and manage this specific cost directly,
          that right can make a real difference.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          you have that figure, or even a realistic range, it&apos;s straightforward to compare
          and size a final expense policy around it, with enough cushion left for the rest of the
          arrangements too.
        </p>
