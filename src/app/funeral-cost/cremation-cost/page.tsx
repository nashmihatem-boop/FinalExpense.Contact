...
export const metadata: Metadata = {
  ...
  description:
    "The real factors that move cremation pricing up or down — service type, urn choice, and provider — and how to compare and get an accurate number for your area.",
  openGraph: { title: "What Affects the Cost of Cremation", description: "The real factors that move cremation pricing up or down — service type, urn choice, and provider — and how to compare and get an accurate number for your area." },

  twitter: { title: "What Affects the Cost of Cremation", description: "The real factors that move cremation pricing up or down — service type, urn choice, and provider — and how to compare and get an accurate number for your area." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          or the more involved, higher end — so you know what to ask when you call around and
          compare.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          only, without any of the services a full-service funeral home provides, comparing prices
        ...
        <div className="mt-8 rounded-2xl border border-mist bg-canvas-alt p-6">
          ...
          <p className="mt-2 text-sm leading-relaxed text-charcoal/75">
            ...
            rather than a bundled package, is the fastest way to see where your money is going
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          local prices shifted. The fast move is to call a provider or two in your area, ask for
          an itemized quote, and use that real number to size a final expense policy that covers
          it with a reasonable cushion left over.
        </p>
