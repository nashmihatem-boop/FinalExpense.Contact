...
export const metadata: Metadata = {
  ...
  description:
    "Why funeral costs vary so much, the general categories you're actually paying for, and how to get a real number fast from local providers before you size coverage.",
  openGraph: { title: "Funeral Cost Guide", description: "Why funeral costs vary so much, the general categories you're actually paying for, and how to get a real number fast from local providers before you size coverage." },

  twitter: { title: "Funeral Cost Guide", description: "Why funeral costs vary so much, the general categories you're actually paying for, and how to get a real number fast from local providers before you size coverage." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          Call two funeral homes in the same city and ask for pricing on a similar set of
          services, and you can get two genuinely different numbers back. That&apos;s normal —
          funeral pricing isn&apos;t standardized or set nationally, and it depends heavily on
          choices only your family can make. This guide is built to get you comparing fast: why
          costs vary, the general categories you&apos;re actually paying for, and where to go for
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          charge the same amount for the same service — which is exactly why comparing more than
          one is worth the extra few minutes.
        </p>
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
        ...
        <div className="mt-8 rounded-2xl border border-mist bg-canvas-alt p-6">
          ...
          <p className="mt-2 text-sm leading-relaxed text-charcoal/75">
            ...
            writing, early, is one of the fastest ways to compare providers accurately.
          </p>
        </div>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          Since none of this is standardized, the fastest way to get a real number is to ask a
