...
export const metadata: Metadata = {
  ...
  description:
    "The real categories of help available when a family can't cover a funeral — and why comparing final expense coverage in advance means you never have to rely on them.",
  openGraph: { title: "Financial Assistance for Funeral Costs", description: "The real categories of help available when a family can't cover a funeral — and why comparing final expense coverage in advance means you never have to rely on them." },

  twitter: { title: "Financial Assistance for Funeral Costs", description: "The real categories of help available when a family can't cover a funeral — and why comparing final expense coverage in advance means you never have to rely on them." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          guide is that comparing coverage ahead of time is what keeps a family from needing any
          of it.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          final expense policy works differently. It&apos;s compared and arranged in advance, it
          pays directly to whoever you name as beneficiary, generally within days of an approved
          claim, and it doesn&apos;t depend on how the death happened or whether a fundraiser
          catches on. That&apos;s the real value in having it — not that it&apos;s the only source
          of help out there, but that it&apos;s the one your family can count on no matter the
          circumstances.
        </p>
