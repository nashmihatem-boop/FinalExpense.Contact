    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          by region, which is exactly why it&apos;s worth comparing itemized quotes from a couple
          of local providers rather than assuming a number.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          The fast answer depends on what matters most: simplicity and a lower cost, or having
