...
export const metadata: Metadata = {
  ...
  description:
    "Every guide on FinalExpense.Contact in one place — coverage by state, pre-existing conditions, funeral costs, managing a policy, avoiding scams, and the basics of life insurance, so you can compare fast.",
  openGraph: { title: "Final Expense Insurance Guides & Resources", description: "Every guide on FinalExpense.Contact in one place — coverage by state, pre-existing conditions, funeral costs, managing a policy, avoiding scams, and the basics of life insurance, so you can compare fast." },

  twitter: { title: "Final Expense Insurance Guides & Resources", description: "Every guide on FinalExpense.Contact in one place — coverage by state, pre-existing conditions, funeral costs, managing a policy, avoiding scams, and the basics of life insurance, so you can compare fast." },
};
...
const BASICS: LinkItem[] = [
  ...
  { href: "/life-insurance-glossary", title: "Life insurance glossary", description: "Quick, plain-English definitions for the terms that come up in every other guide." },
  ...
  { href: "/how-to-choose-a-company", title: "How to choose a company", description: "A fast, carrier-neutral checklist for evaluating any insurer." },
...
const COMPARISONS: LinkItem[] = [
  { href: "/final-expense-vs-term-life", title: "Final expense vs. term life", description: "Two very different products that both get called \"life insurance\" — compared side by side." },
  { href: "/final-expense-insurance-vs-whole-life-insurance", title: "Final expense vs. traditional whole life", description: "Same structure, different scale — how the two stack up." },
  ...
  { href: "/traditional-funeral-vs-direct-burial", title: "Traditional funeral vs. direct burial", description: "A quick, no-figures comparison of the two paths." },
];
...
const HARD_QUESTIONS: LinkItem[] = [
  ...
  { href: "/does-life-insurance-cover-suicide", title: "Does life insurance cover suicide?", description: "A direct explanation of the contestability-period rule." },
  ...
  { href: "/reduce-funeral-costs", title: "How to reduce funeral costs", description: "Legitimate ways to lower the bill without cutting corners." },
  { href: "/what-does-a-funeral-director-do", title: "What does a funeral director do?", description: "Their actual role, explained plainly." },
];

const BY_AGE: LinkItem[] = [
  { href: "/final-expense-insurance-in-your-50s", title: "In your 50s", description: "Often the easiest decade to lock in the best rate." },
  ...
  { href: "/final-expense-insurance/is-it-worth-it", title: "Is it worth it?", description: "A quick, honest look at who this product is, and isn't, built for." },
  { href: "/final-expense-insurance/biggest-mistakes", title: "The biggest mistakes to avoid", description: "Common, avoidable missteps when comparing coverage." },
