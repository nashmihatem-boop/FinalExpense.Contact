...
export const metadata: Metadata = {
  ...
  description:
    "How simplified-issue underwriting treats common health conditions, what level/graded/modified/guaranteed-acceptance actually mean, and how to compare your likely path fast before you apply.",
  openGraph: { title: "Final Expense Insurance with Pre-Existing Conditions", description: "How simplified-issue underwriting treats common health conditions, what level/graded/modified/guaranteed-acceptance actually mean, and how to compare your likely path fast before you apply." },

  twitter: { title: "Final Expense Insurance with Pre-Existing Conditions", description: "How simplified-issue underwriting treats common health conditions, what level/graded/modified/guaranteed-acceptance actually mean, and how to compare your likely path fast before you apply." },
};
...
const FAQS = [
  ...
  },
  {
    ...
    a: "Not usually. Carriers set their own rules and look-back periods, so a decline from one often isn't a decline everywhere — comparing a few at once is the fastest way to find out. Guaranteed acceptance is also always available as a backstop, since it doesn't ask health questions at all.",
  },
  {
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          This guide gives you the fast version: how carriers actually evaluate your health,
          where common conditions typically land, and how to compare your likely path before you
          apply.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          business days, which is exactly what makes comparing more than one carrier&apos;s answer
          practical instead of a weeks-long ordeal.
        </p>
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
        ...
        <p className="mt-4 text-sm leading-relaxed text-charcoal/60">
          ...
          usually just means guaranteed acceptance (or comparing a different carrier) is the next
          step, not that coverage is out of reach entirely.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          different company, and why comparing more than one is worth the two extra minutes.
        </p>
        {grouped.map((g) => (
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          built, and it works in your favor if you compare instead of settling for the first
          answer you get.
        </p>
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          money — or a better tier — on the table. This is exactly where comparing options through
          an independent agency pays off: matching your specific history to the carrier whose
          rules are friendliest to it, fast, before an application ever gets submitted.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          A little preparation goes a long way, and it&apos;s quick. Before you apply, it helps
          to have a clear picture ready: each condition and when it was diagnosed, when you were
          last treated or hospitalized for it, and a complete, current medication list. Carriers
          check your prescription history against your answers, so an accurate list avoids
          surprises and speeds up the comparison.
        </p>
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
