...
export const metadata: Metadata = {
  ...
  description: "Why the medications you take can matter as much as the diagnosis behind them when comparing final expense insurance quotes.",
  openGraph: {
    title: "How Prescription History Affects Your Application",
    description: "Why the medications you take can matter as much as the diagnosis behind them when comparing final expense insurance quotes.",
  },
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          categories, so you can compare your odds before you apply.
        </p>
