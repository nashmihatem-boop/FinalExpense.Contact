...
export const metadata: Metadata = {
  ...
  description:
    "Beyond the funeral itself — probate, medical bills, debt, final utility payments, family travel, and lost income are costs many families don't compare or plan for until it's too late.",
  openGraph: { title: "The Hidden Costs of Dying Families Don't Plan For", description: "Beyond the funeral itself — probate, medical bills, debt, final utility payments, family travel, and lost income are costs many families don't compare or plan for until it's too late." },

  twitter: { title: "The Hidden Costs of Dying Families Don't Plan For", description: "Beyond the funeral itself — probate, medical bills, debt, final utility payments, family travel, and lost income are costs many families don't compare or plan for until it's too late." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-8 text-base leading-relaxed text-charcoal/80">
          ...
          than restricted to a funeral home&apos;s invoice. Comparing a policy now is a fast way
          to close the gap before it opens.
        </p>
