...
export const metadata: Metadata = {
  ...
  description:
    "A fast, plain-language look at who ends up covering funeral and final expenses when there's no life insurance policy in place.",
  openGraph: { title: "What Happens If You Die Without Life Insurance", description: "A fast, plain-language look at who ends up covering funeral and final expenses when there's no life insurance policy in place." },

  twitter: { title: "What Happens If You Die Without Life Insurance", description: "A fast, plain-language look at who ends up covering funeral and final expenses when there's no life insurance policy in place." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          means the people left behind aren&apos;t also left with the bill. Comparing a policy
          today is the fastest way to make sure that gap never opens for your family.
        </p>
