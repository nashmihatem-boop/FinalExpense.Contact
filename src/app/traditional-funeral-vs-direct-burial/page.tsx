...
export const metadata: Metadata = {
  ...
  description:
    "A fast, honest comparison of what a traditional funeral includes versus direct burial, why the cost differs, and how families decide between them.",
  openGraph: { title: "Traditional Funeral vs. Direct Burial", description: "A fast, honest comparison of what a traditional funeral includes versus direct burial, why the cost differs, and how families decide between them." },

  twitter: { title: "Traditional Funeral vs. Direct Burial", description: "A fast, honest comparison of what a traditional funeral includes versus direct burial, why the cost differs, and how families decide between them." },
};
