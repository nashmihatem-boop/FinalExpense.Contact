    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          three outcomes when you compare them side by side. The exact premium always comes down
          to the individual carrier&apos;s own rate table, so &quot;level&quot; describes the
          structure of the benefit rather than a specific price — but structurally, it&apos;s the
          one outcome without a built-in offset for risk the insurer isn&apos;t carrying.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          comparing carriers and finding out rather than assuming an outcome in advance.
        </p>

        <h2 className="mt-14 font-display text-xl font-extrabold text-harbor">
          How to find out if you&apos;d qualify, fast
        </h2>
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          agent who compares your specific history against multiple carriers before you formally
          apply is the fastest way to find the one most likely to offer level — rather than
