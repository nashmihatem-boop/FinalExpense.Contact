    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          works, how it compares to graded, and who typically lands here.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          The fastest way to find out is to have your specific health history compared against
          multiple carriers before you apply, since the line each one draws between graded,
          modified, and guaranteed acceptance is theirs alone to set. An independent agent can do
          that matching for you. And if it turns out your history points toward something with
          even less near-term flexibility, guaranteed acceptance — covered in the{" "}
