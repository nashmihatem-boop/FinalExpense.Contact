    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          history can get two different answers from two different companies, which is exactly
          why comparing options across carriers is worth doing.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          carrier, the fastest way to know for certain is to compare — ideally with a sense, ahead
          of time, of which carriers tend to be more favorable to your specific history. An
