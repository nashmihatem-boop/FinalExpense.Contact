...
export const metadata: Metadata = {
  ...
  description:
    "Yes — a fast look at how holding multiple life insurance policies actually works, why people do it, and when it can draw extra underwriting attention.",
  openGraph: { title: "Can You Have More Than One Life Insurance Policy?", description: "Yes — a fast look at how holding multiple life insurance policies actually works, why people do it, and when it can draw extra underwriting attention." },

  twitter: { title: "Can You Have More Than One Life Insurance Policy?", description: "Yes — a fast look at how holding multiple life insurance policies actually works, why people do it, and when it can draw extra underwriting attention." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          asking until they&apos;re comparing two separate policies and wondering if that&apos;s
          allowed.
        </p>
