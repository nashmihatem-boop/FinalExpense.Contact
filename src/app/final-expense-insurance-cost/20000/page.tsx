    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          the number a lot of people land on once they&apos;ve compared what a full funeral
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          . That balance is why it comes up so often in comparisons with agents, not because
        ...
        <CostFactorsGrid />
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          A fast, free quote is the only way to see what $20,000 in coverage actually costs based
          on your own details, with no obligation to apply.
        </p>
