    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          goal, compare this amount against{" "}
        ...
        <CostFactorsGrid />
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          A fast, free quote is the only way to see what $10,000 in coverage actually costs based
          on your own age, health, and state — no obligation to move forward with it.
        </p>
