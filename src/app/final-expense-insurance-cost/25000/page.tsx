    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          often start comparing what else they&apos;d rather not leave behind for family to sort
          out — though, as with every amount, the actual price is individual to you.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          comparison often shifts toward what happens in the weeks after — final bills that keep
        ...
        <CostFactorsGrid />
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          A fast, free quote is the only way to see what $25,000 in coverage actually costs based
