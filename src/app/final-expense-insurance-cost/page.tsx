...
export const metadata: Metadata = {
  ...
  description:
    "What actually drives your final expense insurance premium, and what coverage amounts from $5,000 to $40,000 and up are typically meant to cover — compared side by side.",
  openGraph: { title: "Final Expense Insurance Cost by Coverage Amount", description: "What actually drives your final expense insurance premium, and what coverage amounts from $5,000 to $40,000 and up are typically meant to cover — compared side by side." },

  twitter: { title: "Final Expense Insurance Cost by Coverage Amount", description: "What actually drives your final expense insurance premium, and what coverage amounts from $5,000 to $40,000 and up are typically meant to cover — compared side by side." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          gives you after a short application. What we can do fast is walk through what actually
          moves your premium, and what different coverage amounts are typically meant to cover, so
          you can compare a target amount against your situation before you ever talk to anyone.
        </p>
        ...
        <div className="mt-8 rounded-2xl border border-mist bg-canvas-alt p-6">
          ...
          <p className="mt-2 text-sm leading-relaxed text-charcoal/75">
            ...
            specifically, a fast, free quote is the only number that counts.
          </p>
        </div>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          amount actually does the job I need it to do.&quot; The sections below let you compare
          that by amount, fast.
        </p>

        <h2 className="mt-14 font-display text-2xl font-extrabold text-harbor">
          Compare cost by coverage amount
        </h2>
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
