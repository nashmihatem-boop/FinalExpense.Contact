    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          specifically for funeral costs. If you&apos;re thinking about $50,000 or more, compare a
          &quot;final expense&quot;-branded product against a standard whole life policy with a
          licensed agent to see which actually fits what you&apos;re trying to do. The label
          matters less than getting the right policy — and if $40,000 feels like more coverage
        ...
        <CostFactorsGrid />
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          A fast, free quote is the most direct way to find out what $40,000 in coverage — or a
          larger whole life policy, if that turns out to be the better fit — actually costs for
          you.
        </p>
