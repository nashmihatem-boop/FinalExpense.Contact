  ...
  return (
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          If you&apos;re not sure $5,000 goes far enough for what you have in mind, compare it
          against a{" "}
          <Link href="/final-expense-insurance-cost/10000" className="text-harbor-mid underline">
            $10,000 policy
          </Link>{" "}
          side by side before you decide — it takes about a minute.
        </p>
        ...
        <CostFactorsGrid />
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          The only way to know what $5,000 in coverage actually costs for you is a fast, free
          quote — it takes about two minutes and comes with no obligation to apply.
        </p>
