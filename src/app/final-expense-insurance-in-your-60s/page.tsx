...
export const metadata: Metadata = {
  ...
  description:
    "What changes when you compare final expense insurance in your 60s, including how pre-existing conditions start to factor into your rate.",
  openGraph: { title: "Final Expense Insurance in Your 60s", description: "What changes when you compare final expense insurance in your 60s, including how pre-existing conditions start to factor into your rate." },

  twitter: { title: "Final Expense Insurance in Your 60s", description: "What changes when you compare final expense insurance in your 60s, including how pre-existing conditions start to factor into your rate." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-8 text-lg leading-relaxed text-charcoal/80">
          A lot of people specifically start comparing final expense insurance in their 60s —
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          your 70s for the identical policy. If the last decade has already passed, the fastest way
          forward is comparing options now, rather than later.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          surprises later and speeds up the comparison. See{" "}
