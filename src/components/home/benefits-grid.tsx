...
function IconScale(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      <path d="M12 3v18M7 7h10M4 7l3-3 3 3M17 7l3-3 3 3" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M4 7l-2 6a3 3 0 006 0zM20 7l-2 6a3 3 0 006 0z" stroke="currentColor" strokeWidth="1.75" strokeLinejoin="round" />
    </svg>
  );
}
...
const BENEFITS = [
  ...
  { Icon: IconScale, title: "Side-by-Side Comparison", body: "See multiple carriers' quotes at once instead of calling around." },
];
    ...
    <section className="bg-canvas">
      <div className="mx-auto max-w-6xl px-5 py-20 sm:px-8 sm:py-28">
        <h2 className="text-center font-display text-3xl font-extrabold text-harbor sm:text-4xl">
          Everything you get when you compare with us
        </h2>

        <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {BENEFITS.map((b) => (
            <div key={b.title} className="rounded-2xl bg-canvas-alt p-7 text-center">
              <span className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-canvas-raised text-harbor shadow-[0_1px_2px_rgba(18,63,42,0.1)]">
