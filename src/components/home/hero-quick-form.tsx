...
export function HeroQuickForm() {
  ...
  return (
    <div className="rounded-2xl border border-mist bg-canvas-raised p-6 shadow-[0_12px_32px_rgba(18,63,42,0.14)] sm:p-8">
      ...
      <div className="mt-5 rounded-xl bg-canvas-alt p-4">
        <p className="text-sm font-bold text-harbor">Start your fast, free quote</p>
