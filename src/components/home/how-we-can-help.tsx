...
const SCENARIOS = [
  {
    ...
    body: "Not sure where to start? We'll show you how it works and get you a quick comparison of what fits your situation, with no pressure to decide today.",
  },
  {
    Icon: IconTrendingDown,
    title: "Looking to lower your payments",
    body: "Already have a policy? We can pull current offers next to it in minutes to see if there's a better rate for the same coverage.",
  },
  {
    Icon: IconTrendingUp,
    title: "Need more coverage than you have",
    body: "If your existing policy would leave a gap, we'll help you compare additional coverage options to close it quickly.",
  },
  {
    Icon: IconGift,
    title: "Want to leave a little extra",
    body: "Beyond funeral costs, some people want to leave a cushion for medical bills or a gift for family. We'll help you compare amounts and land on the right one.",
  },
];
    ...
    <section className="bg-canvas">
      <div className="mx-auto max-w-6xl px-5 py-20 sm:px-8 sm:py-28">
        ...
        <p className="mt-12 text-center font-display text-lg font-bold text-harbor">
          Wherever you are in the process, we&apos;ll help you compare fast.
        </p>
      </div>
    </section>
  );
