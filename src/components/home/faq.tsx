const FAQS = [
  ...
  },
  {
    ...
    a: "Often, yes. Coverage and pricing depend on the condition and the carrier, which is exactly what comparing multiple quotes at once can tell you fast — there's no cost or obligation to find out.",
  },
  {
    q: "How much coverage do I actually need?",
    a: "Most people choose an amount that covers a funeral and burial or cremation, which commonly runs $8,000–$15,000, plus a cushion for any outstanding bills. Comparing a few coverage amounts side by side is the quickest way to land on the right number.",
  },
  {
  ...
  },
  {
    ...
    a: "No. Comparing quotes and talking to an agent costs nothing and doesn't enroll you in anything. You only have coverage if you choose to accept an offer and it's issued by the carrier.",
  },
  {
      ...
      <div className="mx-auto max-w-4xl px-5 py-20 sm:px-8 sm:py-28">
        <div className="max-w-2xl">
          ...
          <h2 className="mt-3 font-display text-3xl font-extrabold text-harbor sm:text-4xl">
            Quick answers, before you start comparing.
          </h2>
        </div>
