      ...
      <div className="mx-auto max-w-5xl px-5 py-20 sm:px-8 sm:py-24">
        <div className="rounded-3xl border border-harbor-mid/15 bg-canvas-alt p-6 sm:p-10">
          ...
          <h2 className="mt-3 max-w-xl font-display text-2xl font-extrabold text-harbor sm:text-3xl">
            Have a health condition? Check the typical outcome first.
          </h2>
          <p className="mt-3 max-w-2xl text-sm leading-relaxed text-charcoal/70">
            A diagnosis rarely rules you out entirely, and knowing the typical outcome ahead of
            time makes comparing quotes faster. Tap any condition below, or read the full guide
            to how simplified-issue underwriting works.
          </p>
