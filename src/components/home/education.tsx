const POINTS = [
  {
    ...
    body: "A typical funeral, burial, and headstone runs well into five figures. Final expense coverage pays out directly to your family so they're not left scrambling to cover it during an already hard week.",
  },
  {
    title: "Built to get you a fast answer",
    body: "Most policies are “simplified issue” — a handful of health questions, no exam, no bloodwork. Coverage decisions typically come back in minutes, not weeks, so you can compare and decide the same day.",
  },
  {
